    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Kaydet.setOnClickListener(view -> {
            ...
            KayitEkle(
                    ...
                    yas.getText().toString(),
                    sehir.getText().toString()
            );
        });
    ...
    private void KayitGoster(Cursor goster) {
        ...
        try {
            while (goster.moveToNext()) {
                ...
                String yass = goster.getString(goster.getColumnIndexOrThrow("yas"));
                String sehirr = goster.getString(goster.getColumnIndexOrThrow("sehir"));
